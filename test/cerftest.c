...
const double abslim = 9e-15; // limit for relative error of absolute value
const double cmplim = 8e-14;   // limit for relative error of Re/Im components
...
int main(void)
{
    ...
    ZTEST(result, abslim, cmplim, cerf(C(-3001, -1000)), C(-1, 0));
    ZTEST(result, abslim, cmplim, cerf(C(1e160, -1e159)), C(1, 0));
    ZTEST(
        result, abslim, cmplim, cerf(C(5.1e-3, 1e-8)),
        C(0.005754683859034800134412990541076554934877,
          0.1128349818335058741511924929801267822634e-7));
    ZTEST(
        result, abslim, cmplim, cerf(C(-4.9e-3, 4.95e-3)),
        C(-0.005529149142341821193633460286828381876955,
          0.005585388387864706679609092447916333443570));
    ZTEST(
        result, abslim, cmplim, cerf(C(4.9e-3, 0.5)),
    ...
    ZTEST(result, abslim, cmplim, cerf(C(0, 2e-6)), C(0, 0.2256758334194034158904576117253481476197e-5));
    ZTEST(result, abslim, cmplim, cerf(C(0, 2)), C(0, 18.56480241457555259870429191324101719886));
    ZTEST(result, abslim, cmplim, cerf(C(0, 20)), C(0, 0.1474797539628786202447733153131835124599e173));
    ZTEST(result, abslim, cmplim, cerf(C(0, 200)), C(0, Inf));
    ZTEST(result, abslim, cmplim, cerf(C(Inf, 0)), C(1, 0));
    ZTEST(result, abslim, cmplim, cerf(C(-Inf, 0)), C(-1, 0));
    ZTEST(result, abslim, cmplim, cerf(C(0, Inf)), C(0, Inf));
    ZTEST(result, abslim, cmplim, cerf(C(0, -Inf)), C(0, -Inf));
    ZTEST(result, abslim, cmplim, cerf(C(Inf, Inf)), C(NaN, NaN));
    ZTEST(result, abslim, cmplim, cerf(C(Inf, -Inf)), C(NaN, NaN));
    ZTEST(result, abslim, cmplim, cerf(C(NaN, NaN)), C(NaN, NaN));
    ZTEST(result, abslim, cmplim, cerf(C(NaN, 0)), C(NaN, 0));
    ZTEST(result, abslim, cmplim, cerf(C(0, NaN)), C(0, NaN));
    ZTEST(result, abslim, cmplim, cerf(C(NaN, Inf)), C(NaN, NaN));
    ZTEST(result, abslim, cmplim, cerf(C(Inf, NaN)), C(NaN, NaN));
    ZTEST(result, abslim, cmplim, cerf(C(1e-3, NaN)), C(NaN, NaN));
    ZTEST(
    ...
    ZTEST(
        ...
        C(0.0003979577342851360897849852457775473112748,
          -0.00002801044116908227889681753993542916894856));
    ZTEST(result, abslim, cmplim, cerfc(C(-3001, -1000)), C(2, 0));
    ZTEST(result, abslim, cmplim, cerfc(C(1e160, -1e159)), C(0, 0));
    ZTEST(
        result, abslim, cmplim, cerfc(C(5.1e-3, 1e-8)),
        C(0.9942453161409651998655870094589234450651,
          -0.1128349818335058741511924929801267822634e-7));
    ZTEST(result, abslim, cmplim, cerfc(C(0, 2e-6)), C(1, -0.2256758334194034158904576117253481476197e-5));
    ZTEST(result, abslim, cmplim, cerfc(C(0, 2)), C(1, -18.56480241457555259870429191324101719886));
    ZTEST(result, abslim, cmplim, cerfc(C(0, 20)), C(1, -0.1474797539628786202447733153131835124599e173));
    ZTEST(result, abslim, cmplim, cerfc(C(0, 200)), C(1, -Inf));
    ZTEST(result, abslim, cmplim, cerfc(C(2e-6, 0)), C(0.9999977432416658119838633199332831406314, 0));
    ZTEST(result, abslim, cmplim, cerfc(C(2, 0)), C(0.004677734981047265837930743632747071389108, 0));
    ZTEST(result, abslim, cmplim, cerfc(C(20, 0)), C(0.5395865611607900928934999167905345604088e-175, 0));
    ZTEST(result, abslim, cmplim, cerfc(C(200, 0)), C(0, 0));
    ZTEST(result, abslim, cmplim, cerfc(C(Inf, 0)), C(0, 0));
    ZTEST(result, abslim, cmplim, cerfc(C(-Inf, 0)), C(2, 0));
    ZTEST(result, abslim, cmplim, cerfc(C(0, Inf)), C(1, -Inf));
    ZTEST(result, abslim, cmplim, cerfc(C(0, -Inf)), C(1, Inf));
    ZTEST(result, abslim, cmplim, cerfc(C(Inf, Inf)), C(NaN, NaN));
    ZTEST(result, abslim, cmplim, cerfc(C(Inf, -Inf)), C(NaN, NaN));
    ZTEST(result, abslim, cmplim, cerfc(C(NaN, NaN)), C(NaN, NaN));
    ZTEST(result, abslim, cmplim, cerfc(C(NaN, 0)), C(NaN, 0));
    ZTEST(result, abslim, cmplim, cerfc(C(0, NaN)), C(1, NaN));
    ...
    ZTEST(
        result, 3.3e-16, 1e-15, cerfi(C(1.234, 0.5678)),
    ...
    ZTEST(
        result, abslim, cmplim, cerfcx(C(1.234, 0.5678)),
