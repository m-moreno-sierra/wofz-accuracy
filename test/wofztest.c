...
const double abslim = 2.1e-14; // limit for relative error of absolute value
const double cmplim = 1.2e-13; // limit for relative error of Re/Im components
// for y<0:
...
// see also at bottom for further exceptions
