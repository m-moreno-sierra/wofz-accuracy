...
const double abslim = 2.2e-15; // limit for relative error of absolute value
...
int main(void)
{
    ...
    /* w(z), computed with WolframAlpha
                     ...
                     to Maple */
    ZTEST(
        result, abslim, cmplim, w_of_z(C(624.2, -0.26123)),
    ...
    ZTEST(
        result, abslim, cmplim, w_of_z(C(-0.7, -0.7)),
    ...
    ZTEST(
        result, abslim, cmplim, w_of_z(C(6.3, -1e-13)),
    ...
    ZTEST(result, abslim, cmplim, w_of_z(C(27.00000000000001, 0)), C(0, 0.0209102719931009));
